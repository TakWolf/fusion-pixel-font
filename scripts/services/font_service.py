...
def _create_builder(
    ...
    builder.meta_info.family_name = f'Fusion Pixel {design_context.font_config.font_size}px {width_mode.capitalize()} {language_flavor}'
...
class FontContext:
    ...
    def make_otf(self):
        ...
        for language_flavor in configs.language_flavors:
            ...
            file_path = path_define.outputs_dir.joinpath(f'fusion-pixel-{self.design_context.font_config.font_size}px-{self.width_mode}-{language_flavor}.otf')
    ...
    def make_woff2(self):
        ...
        for language_flavor in configs.language_flavors:
            builder = self._get_builder(language_flavor)
            file_path = path_define.outputs_dir.joinpath(f'fusion-pixel-{self.design_context.font_config.font_size}px-{self.width_mode}-{language_flavor}.woff2')
    ...
    def make_ttf(self):
        ...
        for language_flavor in configs.language_flavors:
            builder = self._get_builder(language_flavor)
            file_path = path_define.outputs_dir.joinpath(f'fusion-pixel-{self.design_context.font_config.font_size}px-{self.width_mode}-{language_flavor}.ttf')
    ...
    def make_bdf(self):
        ...
        for language_flavor in configs.language_flavors:
            builder = self._get_builder(language_flavor)
            file_path = path_define.outputs_dir.joinpath(f'fusion-pixel-{self.design_context.font_config.font_size}px-{self.width_mode}-{language_flavor}.bdf')
    ...
    def make_pcf(self):
        ...
        for language_flavor in configs.language_flavors:
            builder = self._get_builder(language_flavor)
            file_path = path_define.outputs_dir.joinpath(f'fusion-pixel-{self.design_context.font_config.font_size}px-{self.width_mode}-{language_flavor}.pcf')
    ...
    def make_otc(self):
        ...
        file_path = path_define.outputs_dir.joinpath(f'fusion-pixel-{self.design_context.font_config.font_size}px-{self.width_mode}.otc')
    ...
    def make_ttc(self):
        path_define.outputs_dir.mkdir(parents=True, exist_ok=True)
        collection_builder = self._get_collection_builder()
        file_path = path_define.outputs_dir.joinpath(f'fusion-pixel-{self.design_context.font_config.font_size}px-{self.width_mode}.ttc')
