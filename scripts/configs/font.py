...
class FontConfig:
    ...
    def get_font_file_name(self, width_mode: str, language_flavor: str, font_format: str) -> str:
        return f'fusion-pixel-{self.font_size}px-{width_mode}-{language_flavor}.{font_format}'

    def get_font_collection_file_name(self, width_mode: str, font_format: str) -> str:
        return f'fusion-pixel-{self.font_size}px-{width_mode}.{font_format}'
    ...
    def get_release_zip_file_name(self, width_mode: str, font_format: str) -> str:
        return f'fusion-pixel-font-{self.font_size}px-{width_mode}-{font_format}-v{configs.font_version}.zip'
